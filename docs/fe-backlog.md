...
### A2 · WorkspaceDetailPage — Hiển thị ngày gia nhập — P2 · **Tiến**
...
### A3 · WorkspaceDetailPage — Pending invitations dễ nhận ra hơn — P2 · **Tiến**
...
### A4 · WorkspaceDetailPage — Phân biệt hai loại "xóa" trong dropdown — P3 · **Tiến** · 🟡 Gần xong
...
### A5 · WorkspaceListPage — Empty state khi chưa có workspace — P3 · **Tiến** · ⬜
...
### A6 · ProjectListPage — "New Project" button khi member truy cập — P1 · **Tiến**
...
### A7 · WorkspaceListPage — Stats flash “0 members / 0 projects” — P0 · **Tiến**
...
### A8 · WorkspaceDetailPage — Đếm member gồm pending invite — P0 · **Tiến**
...
### A9 · WorkspaceDetailPage — Project `createdAt` raw ISO — P2 · **Tiến**
...
[ ] A5 · Workspace empty state — link invitations
